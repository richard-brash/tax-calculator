...
var QuestionAnswerComponent = /** @class */ (function () {
    ...
    QuestionAnswerComponent.prototype.ngOnInit = function () {
        ...
        this.questionAnswerService.calculateTax(this.testData).then(function (result) {
            ...
            _this.downloadUrl = 'data:application/pdf;base64,' + _this.testResult.pdf;
        });
    ...
    QuestionAnswerComponent.prototype.b64toBlob = function (b64Data, contentType) {
    ...
    QuestionAnswerComponent.prototype.downloadFile = function () {
        var url = 'data:application/pdf;base64,' + this.testResult.pdf;
        fetch(url)
            .then(function (res) { return res.blob(); })
            .then(function (blob) { return window.URL.createObjectURL(blob); })
            .then(function (url) { return window.open(url, '_blank'); });
    };
...
var ResultComponent = /** @class */ (function () {
    ...
    ResultComponent.prototype.downloadFile = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_primeng_inputswitch__ = __webpack_require__("../../../../primeng/inputswitch.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_primeng_inputswitch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_primeng_inputswitch__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_resolve__ = __webpack_require__("../../../../../src/app/shared/resolve/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_data_sharing__ = __webpack_require__("../../../../../src/app/shared/data-sharing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__question_answer_question_answer_service__ = __webpack_require__("../../../../../src/app/question-answer/question-answer.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__result_component__ = __webpack_require__("../../../../../src/app/result/result.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__result_routing_module__ = __webpack_require__("../../../../../src/app/result/result-routing.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    ResultModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5_primeng_inputswitch__["InputSwitchModule"],
                __WEBPACK_IMPORTED_MODULE_6_primeng_keyfilter__["KeyFilterModule"],
                __WEBPACK_IMPORTED_MODULE_3__angular_router__["RouterModule"].forChild(__WEBPACK_IMPORTED_MODULE_11__result_routing_module__["a" /* resultRoutes */]),
            ],
            declarations: [__WEBPACK_IMPORTED_MODULE_10__result_component__["a" /* ResultComponent */]],
            exports: [__WEBPACK_IMPORTED_MODULE_10__result_component__["a" /* ResultComponent */]],
            providers: [
                __WEBPACK_IMPORTED_MODULE_7__shared_resolve__["a" /* CalculateResolve */],
                __WEBPACK_IMPORTED_MODULE_8__shared_data_sharing__["a" /* DataSharingService */],
                __WEBPACK_IMPORTED_MODULE_9__question_answer_question_answer_service__["a" /* QuestionAnswerService */]
            ]
        })
    ], ResultModule);
    return ResultModule;
